...
export function MenuLayoutClient({ children }: { children: ReactNode }) {
  return (
    <div className="relative isolate min-h-dvh overflow-x-hidden bg-ink text-white antialiased">
      <div
      ...
      />
      <MenuShell>
        <div className="relative z-10 min-h-dvh w-full overflow-hidden">
          {children}
        </div>
      </MenuShell>
    </div>
